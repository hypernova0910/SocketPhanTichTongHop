...
namespace Delaunay
{
    class PhanTichBom
    {
        ...
        public static Double Z_MAX = 6.1;
                ...
                if (findVertexInList(lstCenter, temp) == false)
                {
                    ...
                    for (int i = 0; i < item.Count; i++)
                    {
                        ...
                        if (vectorPhapTuyen.Y != 0)
                        {
                            ...
                            {
                                polygonIntersecD.Add(new Vertex(intersecX, intersecY, M1.Z, Vertex.TYPE_BOMB));
                            }
                        }
                    }
        ...
        public List<Vertex> phanTichBomNew(float minxRec, float minyRec, float maxxRec, float maxyRec, int khoangPT, List<CecmProgramAreaLineDTO> lstRanhDo, double nguong)
        {
            ...
            double trungBinhZToanO = tongZToanO / Set.Count;
            List<double> lstDoSau = new List<double>();
            foreach (var vn in Set)
            {
                lstDoSau.Add(vn.Z);
        ...
        private Vertex getIntersectVertexLineWithPlane(Vertex a, Vertex b, double z)
        {
            ...
            //-z = z0 + ct
            //---
            Vertex vector = new Vertex(a.X - b.X, a.Y - b.Y, a.Z - b.Z, Vertex.TYPE_BOMB);
            ...
            return new Vertex(0, 0, -999999, Vertex.TYPE_BOMB);
        }
        ...
        public Vertex FindCentroid(List<Vertex> Points)
        {
            ...
            return new Vertex(X, Y, Points[0].Z, Vertex.TYPE_BOMB);
        }
