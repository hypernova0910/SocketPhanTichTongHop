...
namespace Delaunay
{
    class PhanTichMin
    {
        ...
        public List<Vertex> phanTichMin(float minxRec, float minyRec, float maxxRec, float maxyRec, int khoangPT)
        {
        ...
        private Vertex findCenter(List<Vertex> poly)
        {
            ...
            return new Vertex(tongX / poly.Count, tongY / poly.Count, z, Vertex.TYPE_MINE);
